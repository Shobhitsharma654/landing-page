# MessBee Retail & Local Page — Typography & Design Guide

This file documents the exact typography specs, styling rules, and layout system implemented on the **Retail & Local Business Solutions** page ([RetailPage.jsx](file:///c:/Users/ACER/Desktop/landing page/landing page/src/components/solutions/RetailPage.jsx)).
...
| :--- | :--- | :--- | :--- | :--- | :--- | :--- |
| **Main Section Headings** | Section titles (e.g. *Practical Tools for Local*) | `32px` (`2.00rem`) | `24px` | `900` (Extra Bold) | `#0F172A` | `1.2` |
| **Main Description Body** | Standard paragraphs explaining local solutions | `12px` | `12.5px` | `400` (Regular) | `#475569` | `1.45` |
| **Card / Item Title** | Headers for key features, reason cards | `12px` | `12px` | `800` (Extra Bold) | `#0F172A` | `1.45` |
...
### A. Hero Section (Retail & Local Business Solutions...)
...
### B. Connected Customer Journey Section (Turn First-Time Visitors...)
...
### C. Practical Tools for Local Businesses Section
*   **Section Header**: `clamp(20px, 2.5vw, 32px)` (line-height: `1.2`)
*   **Practical Tool Cards**:
    *   *Card Title*: `fontSize: 12` (line-height: `1.45`, `fontWeight: 800`)
    *   *Card Text*: `fontSize: 12` (line-height: `1.45`)

### D. Useful for Different Local Businesses Section
*   **Section Header**: `clamp(20px, 2.5vw, 32px)` (line-height: `1.2`)
*   **Business Cards**:
    *   *Card Title*: `fontSize: 12` (line-height: `1.45`, `fontWeight: 800`)
    *   *Card Text*: `fontSize: 12` (line-height: `1.45`)

### E. Why Retail & Local Businesses Choose MessBee Section (Reason Cards)
*   **Section Header**: `clamp(20px, 2.5vw, 32px)` (line-height: `1.2`)
*   **Reason Cards**:
    *   *Card Title*: `fontSize: 12` (line-height: `1.45`, `fontWeight: 800`)
    *   *Card Text*: `fontSize: 12` (line-height: `1.45`)
...
### H. Final CTA Section (Know Your Customers. Stay Connected. Grow Locally.)
*   **Section Header**: `clamp(20px, 2.5vw, 32px)` (line-height: `1.2`)
