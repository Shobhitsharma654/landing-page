        ...
        <div style={{ maxWidth: 1280, margin: "0 auto" }}>
          <div style={{ textAlign: "center", marginBottom: 36 }}>
            ...
            <h2 style={{ fontSize: "clamp(22px, 2.4vw, 34px)", fontWeight: 900, color: "#FFFFFF", letterSpacing: "-1px", marginBottom: 14 }}>
              Keep Customer Conversations <span style={{ color: "#4ADE80" }}>Connected</span>
            </h2>
      ...
      >
        <div style={{ maxWidth: 860, margin: "0 auto", textAlign: "center" }}>
          ...
          <h2 style={{ fontSize: "clamp(24px, 2.6vw, 36px)", fontWeight: 900, color: "#FFFFFF", letterSpacing: "-1px", marginBottom: 14 }}>
            Good Service Starts With Good Customer Management
          </h2>

          <p style={{ fontSize: 13.5, color: "#94A3B8", lineHeight: 1.68, marginBottom: 20, maxWidth: 720, margin: "0 auto 20px" }}>
          ...
          <div style={{ fontSize: 16.5, fontWeight: 900, color: "#4ADE80", marginBottom: 26, letterSpacing: "-0.3px" }}>
            Manage Better. Communicate Better. Serve Better.
          </div>

          <button className="service-btn-primary" onClick={handleStart} style={{ fontSize: 14, padding: "13px 30px" }}>
            Get Started with MessBee
