        ...
        <div style={{ maxWidth: 1280, margin: "0 auto" }}>
          <div style={{ textAlign: "center", marginBottom: 36 }}>
            ...
            <h2 style={{ fontSize: "clamp(22px, 2.4vw, 34px)", fontWeight: 900, color: "#FFFFFF", letterSpacing: "-1px", marginBottom: 14 }}>
              Less Switching. <span style={{ color: "#4ADE80" }}>More Getting Things Done.</span>
            </h2>
            <p style={{ fontSize: 13.5, color: "#94A3B8", maxWidth: 660, margin: "0 auto 8px", lineHeight: 1.68 }}>
            ...
            <p style={{ fontSize: 13.5, fontWeight: 800, color: "#4ADE80", maxWidth: 560, margin: "0 auto" }}>
      ...
      >
        <div style={{ maxWidth: 860, margin: "0 auto", textAlign: "center" }}>
          ...
          <p style={{ fontSize: 15.5, fontWeight: 800, color: "#4ADE80", marginBottom: 12 }}>
            The tools you use should make it easier to build and maintain those relationships.
          </p>
          ...
          <button className="smb-btn-primary" onClick={handleStart} style={{ fontSize: 14, padding: "13px 30px" }}>
            Get Started with MessBee
