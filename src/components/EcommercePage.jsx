        ...
        <div className="ecom-hero-row" style={{ maxWidth: 1280, margin: "0 auto", position: "relative", zIndex: 1 }}>
          ...
          <div style={{ flex: 1.1, minWidth: 320 }}>
            ...
            <div style={{ display: "flex", gap: 12, flexWrap: "wrap" }}>
              <button className="ecom-btn-primary" onClick={handleStart}>
        ...
        <div style={{ maxWidth: 1280, margin: "0 auto" }}>
          <div style={{ textAlign: "center", marginBottom: 36 }}>
            ...
            <h2 style={{ fontSize: "clamp(22px, 2.4vw, 34px)", fontWeight: 900, color: "#FFFFFF", letterSpacing: "-1px", marginBottom: 14 }}>
              Make Customer Communication <span style={{ color: "#4ADE80" }}>Part of Your Store</span>
            </h2>
            <p style={{ fontSize: 13.5, color: "#94A3B8", maxWidth: 660, margin: "0 auto", lineHeight: 1.68 }}>
          ...
          <p style={{ fontSize: 13.5, fontWeight: 800, color: "#4ADE80", textAlign: "center", letterSpacing: "0.2px" }}>
      ...
      >
        <div style={{ maxWidth: 860, margin: "0 auto", textAlign: "center" }}>
          ...
          <h2 style={{ fontSize: "clamp(24px, 2.6vw, 36px)", fontWeight: 900, color: "#FFFFFF", letterSpacing: "-1px", marginBottom: 14 }}>
            Your Store Is More Than a Catalogue
          </h2>

          <p style={{ fontSize: 15.5, fontWeight: 800, color: "#4ADE80", marginBottom: 12 }}>
            Products bring customers to your store. Relationships bring them back.
          </p>
          ...
          <button className="ecom-btn-primary" onClick={handleStart} style={{ fontSize: 14, padding: "13px 30px" }}>
            Get Started with MessBee
