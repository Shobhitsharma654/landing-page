...
const WhatsappQrGenerator = () => {
  ...
  const downloadQRCode = () => {
    ...
    // 2. Top-Left Light Green Corner Accent
    ...
    // 3. Bottom-Right Light Green Corner Accent
    ctx.fillStyle = "#D1FAE5";
    ctx.beginPath();
    ctx.moveTo(800, 1200);
    ctx.lineTo(560, 1200);
    ctx.bezierCurveTo(670, 1200, 800, 1070, 800, 960);
    ctx.closePath();
    ctx.fill();
    ...
    ctx.beginPath();
    ctx.moveTo(800, 960);
    ctx.bezierCurveTo(800, 1070, 670, 1200, 560, 1200);
    ctx.stroke();
  ...
  return (
    <div style={{ fontFamily: "'Inter', sans-serif", background: "#F8FAFC", minHeight: "100vh", display: "flex", flexDirection: "column" }}>
      ...
      <main style={{ flex: 1, padding: "86px 16px 40px 16px", width: "100%", maxWidth: "100vw", overflowX: "hidden" }}>
        <div style={{ maxWidth: 720, margin: "0 auto", width: "100%" }}>
          
          <div style={{ textAlign: "center", marginBottom: 20 }}>
            <div style={{ display: "inline-flex", alignItems: "center", gap: 5, background: "#ECFDF5", borderRadius: 40, padding: "3px 10px", marginBottom: 8, border: "1px solid #A7F3D0" }}>
              <div style={{ width: 5, height: 5, borderRadius: "50%", background: "#16A34A" }} />
              <span style={{ fontSize: 10, fontWeight: 700, color: "#047857" }}>Free Business Tool</span>
            </div>
            <h1 style={{ fontSize: "clamp(20px, 2.2vw, 28px)", fontWeight: 900, color: "#0F172A", marginBottom: 8, letterSpacing: "-0.5px", lineHeight: 1.15 }}>
              Free WhatsApp <span style={{ color: "#16A34A" }}>QR Code Generator</span>
            </h1>
            <p style={{ fontSize: 13, color: "#64748B", maxWidth: 440, margin: "0 auto", lineHeight: 1.45 }}>
          ...
          <div style={{ display: "flex", flexWrap: "wrap", gap: 18, background: "#FFFFFF", borderRadius: 16, padding: 18, boxShadow: "0 8px 24px -8px rgba(0,0,0,0.06)", border: "1px solid #E2E8F0", width: "100%" }}>
            
            {/* Left Side: Form */}
            <div style={{ flex: "1 1 270px", minWidth: 0, width: "100%" }}>
              <h3 style={{ fontSize: 14, fontWeight: 700, color: "#0F172A", marginBottom: 12 }}>Enter Your Details</h3>
              ...
              <div style={{ marginBottom: 10 }}>
                ...
                <input 
                  ...
                  style={{ width: "100%", padding: "7px 11px", borderRadius: 8, border: "1px solid #CBD5E1", fontSize: 12.5, background: "#F8FAFC", outline: "none", boxSizing: "border-box" }}
              ...
              <div style={{ marginBottom: 10 }}>
                ...
                <input 
                  ...
                  style={{ width: "100%", padding: "5px 8px", borderRadius: 8, border: "1px dashed #CBD5E1", fontSize: 11.5, background: "#F8FAFC", outline: "none", cursor: "pointer", boxSizing: "border-box" }}
              ...
              <div style={{ marginBottom: 10 }}>
                ...
                <div style={{ display: "flex", gap: 8, width: "100%" }}>
                  <select 
                    ...
                    style={{ padding: "7px 8px", borderRadius: 8, border: "1px solid #CBD5E1", fontSize: 12.5, background: "#F8FAFC", outline: "none", cursor: "pointer", width: 90, flexShrink: 0, boxSizing: "border-box" }}
                    onFocus={(e) => e.target.style.border = "1px solid #16A34A"}
                    onBlur={(e) => e.target.style.border = "1px solid #CBD5E1"}
                  >
                  ...
                  <input 
                    ...
                    style={{ flex: 1, minWidth: 0, width: "100%", padding: "7px 11px", borderRadius: 8, border: "1px solid #CBD5E1", fontSize: 12.5, background: "#F8FAFC", outline: "none", boxSizing: "border-box" }}
                    onFocus={(e) => e.target.style.border = "1px solid #16A34A"}
                    onBlur={(e) => e.target.style.border = "1px solid #CBD5E1"}
                  />
                </div>
                <p style={{ fontSize: 10, color: "#94A3B8", marginTop: 3 }}>Don't use +, -, or brackets. Just the digits.</p>
              </div>
              ...
              <div style={{ marginBottom: 14 }}>
                ...
                <textarea 
                  ...
                  rows="2"
                  style={{ width: "100%", padding: "7px 11px", borderRadius: 8, border: "1px solid #CBD5E1", fontSize: 12.5, background: "#F8FAFC", outline: "none", resize: "none", boxSizing: "border-box" }}
                  onFocus={(e) => e.target.style.border = "1px solid #16A34A"}
                  onBlur={(e) => e.target.style.border = "1px solid #CBD5E1"}
                />
                <p style={{ fontSize: 10, color: "#94A3B8", marginTop: 3 }}>Message will automatically appear in user's chat.</p>
              </div>
              ...
              <button 
                ...
                style={{
                  width: "100%", background: "#16A34A", color: "#FFFFFF", border: "none", borderRadius: 8, padding: "9px 14px", fontSize: 13, fontWeight: 700, cursor: isGenerating ? "not-allowed" : "pointer", display: "flex", alignItems: "center", justifyContent: "center", gap: 6, transition: "background 0.2s"
                }}
            ...
            <div style={{ flex: "1 1 270px", display: "flex", flexDirection: "column", alignItems: "center", justifyContent: "center", background: "#F1F5F9", borderRadius: 12, padding: 16, border: "1px dashed #CBD5E1", minWidth: 0, width: "100%" }}>
              {generatedLink ? (
                <div style={{ display: "flex", flexDirection: "column", alignItems: "center", gap: 12, width: "100%" }}>
                  
                  {/* Standee Poster Preview Card */}
                  <div style={{ background: "#FFFFFF", borderRadius: 16, overflow: "hidden", boxShadow: "0 8px 24px rgba(0,0,0,0.08)", width: "100%", maxWidth: 260, border: "1px solid #E2E8F0", position: "relative", padding: "12px 10px 10px 10px" }}>
                    
                    {/* Top Left Curve Accent */}
                    <div style={{ position: "absolute", top: 0, left: 0, width: 60, height: 60, pointerEvents: "none", zIndex: 1 }}>
                      <svg width="60" height="60" viewBox="0 0 100 100" fill="none">
                        <path d="M0 0 H100 C60 0, 0 60, 0 100 Z" fill="#D1FAE5" />
                    ...
                    <div style={{ position: "absolute", bottom: 0, right: 0, width: 60, height: 60, pointerEvents: "none", zIndex: 1 }}>
                      <svg width="60" height="60" viewBox="0 0 100 100" fill="none">
                        <path d="M100 100 H0 C40 100, 100 40, 100 0 Z" fill="#D1FAE5" />
                        <path d="M100 0 C100 45, 45 100, 0 100" stroke="#16A34A" strokeWidth="5" fill="none" />
                      </svg>
                    </div>

                    {/* Top-Right Decorative Dots */}
                    <div style={{ position: "absolute", top: 8, right: 8, display: "grid", gridTemplateColumns: "repeat(5, 2.5px)", gap: 3, opacity: 0.25, pointerEvents: "none" }}>
                      {[...Array(20)].map((_, i) => (
                        <div key={i} style={{ width: 2.5, height: 2.5, borderRadius: "50%", background: "#64748B" }} />
                      ))}
                    </div>

                    {/* Top-Left Decorative Dots */}
                    <div style={{ position: "absolute", top: 30, left: 6, display: "grid", gridTemplateColumns: "repeat(3, 2.5px)", gap: 3, opacity: 0.25, pointerEvents: "none" }}>
                      {[...Array(12)].map((_, i) => (
                        <div key={i} style={{ width: 2.5, height: 2.5, borderRadius: "50%", background: "#64748B" }} />
                      ))}
                    </div>
                    ...
                    <div style={{ position: "relative", zIndex: 2, margin: "6px auto 4px auto", width: 50, height: 50, borderRadius: "50%", background: "#FFFFFF", boxShadow: "0 4px 12px rgba(0,0,0,0.08)", border: "2.5px solid #F1F5F9", display: "flex", alignItems: "center", justifyContent: "center", padding: 4 }}>
                      {logoUrl ? (
                    ...
                    <div style={{ position: "relative", zIndex: 2, textAlign: "center" }}>
                      ...
                      <div style={{ display: "flex", alignItems: "center", justifyContent: "center", gap: 4, margin: "5px 0 6px 0" }}>
                        <div style={{ width: 18, height: 1.5, background: "#16A34A" }} />
                        <div style={{ width: 3.5, height: 3.5, borderRadius: "50%", background: "#16A34A" }} />
                        <div style={{ width: 18, height: 1.5, background: "#16A34A" }} />
                      </div>

                      {/* Phone Pill Badge */}
                      <div style={{ display: "inline-flex", alignItems: "center", gap: 5, background: "#FFFFFF", border: "1px solid #E2E8F0", borderRadius: 24, padding: "3px 10px", boxShadow: "0 2px 6px rgba(0,0,0,0.04)", marginBottom: 8 }}>
                        <div style={{ width: 15, height: 15, borderRadius: "50%", background: "#16A34A", display: "flex", alignItems: "center", justifyContent: "center", flexShrink: 0 }}>
                          <svg width="8" height="8" viewBox="0 0 24 24" fill="#FFF"><path d="M6.62 10.79a15.053 15.053 0 006.59 6.59l2.2-2.2c.27-.27.67-.36 1.02-.24 1.12.37 2.33.57 3.57.57.55 0 1 .45 1 1V20c0 .55-.45 1-1 1-9.39 0-17-7.61-17-17 0-.55.45-1 1-1h3.5c.55 0 1 .45 1 1 0 1.25.2 2.45.57 3.57.11.35.03.74-.25 1.02l-2.2 2.2z"/></svg>
                        </div>
                        <span style={{ fontSize: 10.5, fontWeight: 900, color: "#001A36", letterSpacing: "0.2px" }}>
                      ...
                      <div style={{ position: "relative", display: "inline-block", padding: 6, background: "#FFFFFF", border: "1.5px solid #16A34A", borderRadius: 12, marginBottom: 8 }}>
                        ...
                        <div style={{ position: "absolute", top: "50%", left: "50%", transform: "translate(-50%, -50%)", width: 26, height: 26, borderRadius: "50%", background: "#FFFFFF", display: "flex", alignItems: "center", justifyContent: "center", boxShadow: "0 2px 6px rgba(0,0,0,0.18)", padding: 2 }}>
                      ...
                      {/* 4 Feature Badges */}
                      <div style={{ display: "grid", gridTemplateColumns: "repeat(4, 1fr)", gap: 2, marginTop: 4, padding: "4px 0 0 0" }}>
                        <div style={{ textAlign: "center", padding: "0 1px" }}>
                          <div style={{ width: 18, height: 18, borderRadius: "50%", background: "#F1F5F9", display: "flex", alignItems: "center", justifyContent: "center", margin: "0 auto 2px auto" }}>
                            <svg width="9" height="9" viewBox="0 0 24 24" fill="none" stroke="#16A34A" strokeWidth="2.5"><polygon points="13 2 3 14 12 14 11 22 21 10 12 10 13 2"/></svg>
                          </div>
                        ...
                        <div style={{ textAlign: "center", padding: "0 1px", borderLeft: "1px solid #E2E8F0" }}>
                          <div style={{ width: 18, height: 18, borderRadius: "50%", background: "#F1F5F9", display: "flex", alignItems: "center", justifyContent: "center", margin: "0 auto 2px auto" }}>
                            <svg width="9" height="9" viewBox="0 0 24 24" fill="none" stroke="#16A34A" strokeWidth="2.5"><path d="M12 22s8-4 8-10V5l-8-3-8 3v7c0 6 8 10 8 10z"/><polyline points="9 12 11 14 15 10"/></svg>
                          </div>
                        ...
                        <div style={{ textAlign: "center", padding: "0 1px", borderLeft: "1px solid #E2E8F0" }}>
                          <div style={{ width: 18, height: 18, borderRadius: "50%", background: "#F1F5F9", display: "flex", alignItems: "center", justifyContent: "center", margin: "0 auto 2px auto" }}>
                            <svg width="9" height="9" viewBox="0 0 24 24" fill="none" stroke="#16A34A" strokeWidth="2.5"><path d="M17 21v-2a4 4 0 0 0-4-4H5a4 4 0 0 0-4 4v2"/><circle cx="9" cy="7" r="4"/><path d="M23 21v-2a4 4 0 0 0-3-3.87"/><path d="M16 3.13a4 4 0 0 1 0 7.75"/></svg>
                          </div>
                        ...
                        <div style={{ textAlign: "center", padding: "0 1px", borderLeft: "1px solid #E2E8F0" }}>
                          <div style={{ width: 18, height: 18, borderRadius: "50%", background: "#F1F5F9", display: "flex", alignItems: "center", justifyContent: "center", margin: "0 auto 2px auto" }}>
                            <svg width="9" height="9" viewBox="0 0 24 24" fill="#16A34A"><polygon points="12 2 15.09 8.26 22 9.27 17 14.14 18.18 21.02 12 17.77 5.82 21.02 7 14.14 2 9.27 8.91 8.26 12 2"/></svg>
                          </div>
                          <div style={{ fontSize: 6.5, fontWeight: 700, color: "#334155", lineHeight: 1.1 }}>Fast &amp; Easy</div>
                        </div>
                      </div>

                      {/* Footer: Powered By MessBee */}
                      <div style={{ display: "flex", alignItems: "center", justifyContent: "center", gap: 4, marginTop: 8 }}>
                        <div style={{ width: 22, height: 1, background: "#16A34A" }} />
                        <span style={{ fontSize: 7, color: "#64748B", fontWeight: 600 }}>Powered By</span>
                        <div style={{ display: "flex", alignItems: "center", gap: 2 }}>
                          <img src={defaultLogo} alt="MessBee" style={{ height: 9, objectFit: "contain" }} />
                          <span style={{ fontSize: 7.5, fontWeight: 900, fontFamily: "'Inter', sans-serif" }}>
                  ...
                  <div style={{ display: "flex", gap: 6, width: "100%", justifyContent: "center", flexWrap: "wrap", marginTop: 4 }}>
                    <button 
                      onClick={downloadQRCode}
                      style={{ background: "#001A36", color: "#FFFFFF", border: "none", borderRadius: 6, padding: "6px 14px", fontSize: 11.5, fontWeight: 600, cursor: "pointer", display: "flex", alignItems: "center", gap: 5, transition: "background 0.2s" }}
                    ...
                    <button 
                      ...
                      style={{ background: "#FFFFFF", color: "#001A36", border: "1px solid #CBD5E1", borderRadius: 6, padding: "6px 14px", fontSize: 11.5, fontWeight: 600, cursor: "pointer", display: "flex", alignItems: "center", gap: 5, transition: "background 0.2s" }}
                ...
                <div style={{ textAlign: "center", color: "#94A3B8", padding: "20px 0" }}>
                  <svg width="36" height="36" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" style={{ marginBottom: 10 }}><rect x="3" y="3" width="18" height="18" rx="2" ry="2"/><rect x="7" y="7" width="3" height="3"/><rect x="14" y="7" width="3" height="3"/><rect x="7" y="14" width="3" height="3"/><rect x="14" y="14" width="3" height="3"/></svg>
                  <p style={{ fontSize: 13, fontWeight: 500 }}>Your QR Code will appear here.</p>
                </div>
              )}
            </div>
          </div>
